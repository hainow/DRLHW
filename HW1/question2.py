...
def execute_optimal_policy(env, policy, verbose=False):
    total_reward = 0.
    num_steps = 0
    # print(policy)
...
def question_2_b():
    for env_name, map_size in [('Stochastic-4x4-FrozenLake-v0', 4), ('Stochastic-8x8-FrozenLake-v0', 8)]:
        ...
        for _ in range(iters):
            ...
            reward, num_steps = execute_optimal_policy_cummulative(env, optimal_policy, gamma=.9)
            total_reward += reward
